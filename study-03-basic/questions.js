const quizQuestions = [
    ...
    },
    {
        ...
        category: "한국사",
        difficulty: "hard",
        question: "고려 왕조 대부분 시기의 수도는 어디였나요?",
        options: ["한양", "평양", "개경", "경주"],
        correctAnswer: 2,
        explanation: "고려의 수도는 개경(현재의 개성)이었습니다. 단, 1232~1270년 대몽항쟁기에는 강화도로 천도하기도 했습니다."
    },
    {
        id: 5,
        category: "한국사",
    ...
    },
    {
        ...
        category: "한국사",
        difficulty: "medium",
        question: "1170년 무신정변 직후, 무신정권 초기의 최고 권력기구는?",
        options: ["중방", "정방", "도방", "삼별초"],
        correctAnswer: 0,
        explanation: "중방은 1170년 무신정변 직후 무신정권 초기의 최고 권력기구였습니다. 이후 최씨 정권 시기에는 교정도감과 정방이 핵심 기구가 되었습니다."
    },
    {
        id: 42,
        category: "한국사",
    ...
    },
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "주류 학설(전통적 측정) 기준, 세계에서 가장 긴 강은?",
        options: ["아마존강", "나일강", "양쯔강", "미시시피강"],
        correctAnswer: 1,
        explanation: "나일강은 약 6,650km로 전통적으로 세계에서 가장 긴 강으로 알려져 있습니다. 다만 2007년 이후 일부 연구는 아마존강(약 6,992km)이 더 길다고 주장하기도 합니다."
    },
    {
        id: 13,
        category: "세계지리",
    ...
    },
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "극지 사막을 포함하여, 면적 기준 세계에서 가장 큰 사막은?",
        options: ["사하라 사막", "고비 사막", "남극 사막", "아라비아 사막"],
        correctAnswer: 2,
        explanation: "사막은 연 강수량 250mm 미만의 지역을 의미하며, 이 분류에 따르면 남극 대륙(약 1,400만km²)이 세계 최대 사막입니다. 모래사막 중에서는 사하라 사막이 가장 큽니다."
    },
    {
        id: 16,
        category: "세계지리",
    ...
    },
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "해발(평균해수면) 기준, 세계에서 가장 높은 산은?",
        options: ["K2", "에베레스트", "칸첸중가", "마칼루"],
        correctAnswer: 1,
        explanation: "에베레스트산은 해발 8,848.86m로 해수면 기준 세계 최고봉입니다. (참고: 지구 중심에서의 거리 기준으로는 에콰도르의 친보라소산이 가장 멉니다.)"
    },
    {
        id: 18,
        category: "세계지리",
        difficulty: "hard",
        question: "면적 기준, 염호를 포함한 세계에서 가장 큰 호수는?",
        options: ["바이칼호", "슈피리어호", "카스피해", "빅토리아호"],
        correctAnswer: 2,
        explanation: "카스피해는 약 371,000km²로 세계 최대의 호수입니다(염호로 분류 시). 담수호 중에서는 슈피리어호가 가장 큽니다."
    },
    {
        id: 19,
        category: "세계지리",
    ...
    },
    {
        ...
        category: "과학",
        difficulty: "medium",
        question: "지름과 질량 기준, 태양계에서 가장 큰 행성은?",
        options: ["토성", "목성", "천왕성", "해왕성"],
        correctAnswer: 1,
        explanation: "목성은 지름 약 142,984km, 질량은 지구의 약 318배로 태양계에서 가장 큰 행성입니다."
    },
    {
        id: 23,
        category: "과학",
    ...
    },
    {
        ...
        category: "과학",
        difficulty: "hard",
        question: "1953년 DNA 이중나선 구조를 논문으로 발표한 과학자는?",
        options: ["다윈", "아인슈타인", "왓슨과 크릭", "멘델"],
        correctAnswer: 2,
        explanation: "제임스 왓슨과 프랜시스 크릭은 1953년 Nature지에 DNA 이중나선 구조 논문을 발표했습니다. 이 발견에는 로잘린드 프랭클린의 X선 회절 사진(Photo 51)이 결정적 역할을 했습니다."
    },
    {
        id: 25,
        category: "과학",
    ...
    },
    {
        ...
        category: "과학",
        difficulty: "easy",
        question: "면적과 무게 기준, 인체에서 가장 큰 장기는?",
        options: ["심장", "간", "폐", "피부"],
        correctAnswer: 3,
        explanation: "피부는 면적 약 1.5~2m², 체중의 약 16%를 차지하는 인체 최대 장기입니다. 내부 장기 중에서는 간이 가장 큽니다."
    },
    {
        id: 30,
        category: "과학",
    ...
    },
    {
        ...
        category: "예술과 문화",
        difficulty: "easy",
        question: "한국의 전통 음악을 통칭하는 용어는?",
        options: ["가요", "국악", "민요", "판소리"],
        correctAnswer: 1,
        explanation: "국악(國樂)은 한국 전통 음악 전체를 통칭하는 용어입니다. 민요와 판소리는 국악의 하위 갈래에 해당합니다."
    },
    {
        id: 40,
        category: "예술과 문화",
...
,
    ...
    },
    {
        ...
        category: "한국사",
        difficulty: "medium",
        question: "고려 광종이 958년 도입한 인재 등용 제도는?",
        options: ["음서제","독서삼품과","향약","과거제"],
        correctAnswer: 3,
        explanation: "고려 광종은 958년 후주 출신 쌍기의 건의를 받아들여 과거제를 도입했습니다. 시험을 통한 관리 선발을 처음 제도화한 사례입니다. (참고: 독서삼품과는 통일신라 원성왕 때, 음서제는 고려시대 귀족 자제 등용 제도, 향약은 조선시대 향촌 자치 규약입니다.)"
    }];
